  ...
  function settingSessionsAcordion(id, title, info, typeOfSession, membersLimit, timeS, timeE, Opt1TS, Opt1TE, Opt2TS, Opt2TE, Opt3TS, Opt3TE, members) {
        ...
        switch(typeOfSession){
          case "request": {
                            ...
                            typeOfSessionDisplay = `<ul class="eachSessionCard"><li class="float-left"><h3> <button class="takeOnIt">Help Out</button></h3></li><li> <h4 float-none>${title}</h4></li> <li class="float-right"> <p> by: ${members[0].first_name} ${members[0].last_name}</p></li></ul>`
                            collapseCard = `<div id="collapse${id}" class="collapse" aria-labelledby="heading${id}" data-parent="#accordion">
                            <div class="card-body">
                            <table>
                            <tr>
